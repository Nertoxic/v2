...
if (file_exists($zip_file)) {
    ...
    if ($zip->open($zip_file) === TRUE) {
        ...
        $response = "The Update has been installed successfully";
    } else {
        $response = "There was an error while installing the newest update!";
    }
} else {
    $response = "There is currently no new update available!";
}
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    <div class="">
        <div class="flex items-center pt-8 sm:justify-start sm:pt-0">
            <h1 class="px-4 text-lg text-gray-500 border-r border-gray-400 tracking-wider">
                NIC
            </h1>
